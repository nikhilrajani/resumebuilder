...
const ExtraCurricularDetailsForm = ({ enableNext }) => {
  ...
  const onSummaryChange = (index, value) => {
    ...
    updatedResume.extraCurricular = value;
    setResumeInfo(updatedResume);
  };
  return (
    <div className="p-5 shadow-md rounded-lg border-t-primary border-t-4 mt-10">
      <h2 className="font-bold text-lg">Extra Curricular Details</h2>
      <p>Tell us about your involvements outside academics</p>
      <div className="col-span-3 mt-2">
        <RichTextEditor
          onRichTextEditorChange={onSummaryChange}
          index={0}
          defaultValue={resumeInfo.extraCurricular}
        />
      </div>
...
export default ExtraCurricularDetailsForm;
