...
const CourseworkDetailsForm = ({ enableNext }) => {
  ...
  const onSummaryChange = (index, value) => {
    ...
    updatedResume.coursework = value;
  ...
  return (
    <div className="p-5 shadow-md rounded-lg border-t-primary border-t-4 mt-10">
      <h2 className="font-bold text-lg">Coursework Details</h2>
      <p>Let us know about your courses</p>
      <div className="col-span-3 my-2">
        <RichTextEditor
          onRichTextEditorChange={onSummaryChange}
          index={0}
          defaultValue={resumeInfo.coursework}
        />
      </div>
...
export default CourseworkDetailsForm;
